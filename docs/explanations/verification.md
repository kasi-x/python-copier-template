...
|---|---|---|---|---|
| `test-fast` | `-m "not heavy and not slow and not meta and not network"` | 998 | 30s (measured 18.6s) | 2026-09-20 |
...
| `test` | `—` | 1065 | measured 178.6s | 2026-09-17 |
| `test-randomly` | `-m "not heavy and not slow and not meta and not network"` | 998 | measured 22.3s | 2026-09-17 |
