...
|---|---|---|---|---|
| `test-fast` | `-m "not heavy and not slow and not meta and not network"` | 958 | 30s (measured 17.7s) | 2026-09-20 |
...
| `test` | `—` | 1025 | measured 178.6s | 2026-09-17 |
| `test-randomly` | `-m "not heavy and not slow and not meta and not network"` | 958 | measured 22.3s | 2026-09-17 |
